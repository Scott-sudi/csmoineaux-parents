"""Génère les icônes Flutter à partir de images/mes_icons."""
...
SRC_DIR = Path(__file__).resolve().parents[3] / "images" / "mes_icons"
# parents: tool -> kalunga_parents -> mobile -> kalunga-school
