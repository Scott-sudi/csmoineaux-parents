...
/**
 * Notifications système avec monogramme MN + logo Moineaux (style WhatsApp).
 */
object NotificationBranding {
    ...
    fun ensureChannel(context: Context) {
        ...
        val channel = NotificationChannel(
            ...
            enableLights(true)
            lightColor = ContextCompat.getColor(context, R.color.moineaux_notify)
            setShowBadge(true)
    ...
    fun show(context: Context, title: String, body: String): Boolean {
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setColor(ContextCompat.getColor(context, R.color.moineaux_notify))
